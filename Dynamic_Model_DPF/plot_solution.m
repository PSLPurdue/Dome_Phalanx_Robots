function [] = plot_solution(state_Vec,coords0,BC_nodes,connecBistable,connecRigid,Nnodes,number_of_segments,segment_length,segment_height)
...
for pair = connecBistable'
    ...
    line(x,y, 'Color',bi_spring_color)
...
legend(h, 'Unactive Unit','Active Unit','Location','Southeast');
